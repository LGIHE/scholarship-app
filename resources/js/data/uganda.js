...
export const DISTRICTS_BY_REGION = {
    Central: [
        'Buikwe', 'Bukomansimbi', 'Butebo', 'Buvuma', 'Gomba',
    ...
    Eastern: [
        ...
        'Kamuli', 'Kapchorwa', 'Katakwi', 'Kibuku', 'Kumi',
        'Kween', 'Luuka', 'Manafwa', 'Mayuge', 'Mbale',
    ...
    Northern: [
        ...
        'Moyo', 'Madi-Okollo', 'Napak', 'Nebbi', 'Nwoya',
        'Obongi', 'Omoro', 'Otuke', 'Oyam', 'Pader',
    ...
    Western: [
        ...
        'Kibaale', 'Kikuube', 'Kiruhura', 'Kiryandongo', 'Kisoro',
